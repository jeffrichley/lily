...
- phase-level execution scope, checklist status, and acceptance gates for this domain

This document is not authoritative for:
- global priority/story sequencing (`docs/dev/roadmap.md`)
- cross-domain running diary status (`docs/dev/status.md`)
- debt registry ownership (`docs/dev/debt/debt_tracker.md`)
...
- [x] Long-term memory store API used for repository adapters
- [x] Structured output strategy used where response schemas are required
